...
class TranslateBook(tk.Tk):
    def __init__(self):
        ...
        self.languages_menu = tk.Menu(self.menu, tearoff=0, bg='lightgrey',
                                      fg='black')
        self.languages_menu.add_command(label='Portuguese', 
                                        command=self.add_portuguese_tab)
    ...
    def translate(self, target_language=None, text=None, elements=None):
        if not text:
        ...
        try:
            for code, element in zip(target_language, elements):
    ...
    def add_portuguese_tab(self):
        ...
        self.portuguese_label = tk.Label(portuguese_tab, textvar=self.portuguese_translation,
                                         bg='lightgrey', fg='black'
                                         )
